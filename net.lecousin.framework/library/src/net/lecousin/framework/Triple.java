...
public class Triple<T1,T2,T3> {
    ...
    public boolean equals(Object obj) {
    	...
    	if (!CommonUtil.equalsOrNull(value1, ((Triple<?,?,?>)obj).value1))
    		return false;
    	if (!CommonUtil.equalsOrNull(value2, ((Triple<?,?,?>)obj).value2))
    		return false;
    	if (!CommonUtil.equalsOrNull(value3, ((Triple<?,?,?>)obj).value3))
    		return false;
    	return true;
    }
    ...
    public String toString() {
    	return new StringBuilder("{").append(value1 == null ? "null" : value1.toString()).append(",").append(value2 == null ? "null" : value2.toString()).append(",").append(value3 == null ? "null" : value3.toString()).append("}").toString();
    }
}
